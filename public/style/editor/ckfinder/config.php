...
switch ($SERVER_NAME) {
    case 'my-blog.local':
        $licenseName = 'my-blog.local';
        $licenseKey = 'TFPFPPF3Y772UZMR271EYHSNRHFMJ';
        break;
    case 'sieuthilongmi.net':
        $licenseName = 'sieuthilongmi.net';
        $licenseKey = 'KT8T1G4Q7XN958PRRBEGHHWLFQKAJ';
        break;
    default:
        $licenseName = '';
        $licenseKey = '';
