...
class ConfigsTextSeoController extends Controller
{
	private $key_config = 'seo';
    ...
    public function index(){
    	...
    	return view('admin.page.configs-text.index-seo', ['get_value'=>$get_value]);
    }
    public function update(Request $request){
    	...
    	if(!empty($array_input_text)){
	    	foreach ($array_input_text as $item) {
	    		$data_save[$item] = remove_tag_script($request->get($item));
	    	}
    	}
