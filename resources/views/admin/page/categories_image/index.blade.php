...
@section('content')
	<div class="page-content-wrapper">
	    <div class="page-content">
	        ...
	        <form action="{{route('admin.categories-post-management.index')}}" method="GET" class="form-filter">
				<div class="row">
					<div class="col-md-3">
    		...
    		<div class="row">
    			<div class="col-md-12">
	                <div class="btn-group">
	                	<a href="{{route('admin.categories-post-management.create')}}">
                                ...
                                <tbody>
                                	...
                                	<tr>
                                		...
                                		<td class="text-center">
                                    		...
                                    		<a href="{{route('admin.categories-post-management.edit',['id'=>$item->id])}}"><span class="label label-sm label-warning" title="Sửa"><i class="fa fa-edit"></i></span></a>&nbsp;
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.click-to-delete').on('click', function(e){
			e.preventDefault();
			var url = '{{route('admin.categories-post-management.delete',['id'=>'::id'])}}';
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.click-to-view').on('click', function(e){
			e.preventDefault();
			var url = '{{route('admin.categories-post-management.ajax_view',['id'=>'::id'])}}';
			var	get_id = $(this).data('id');
			url = url.replace('::id',get_id);
			$.ajax({
				type:'GET',
...
<script>
	$(document).on('click','.btn-action',function(){
		...
		if(val_action == 'delete'){
	        ...
	        url_select = "{{route('admin.categories-post-management.update-select-box-delete',['params'=>':params'])}}"
		...
		if(val_action == 'active'){
	        ...
	        url_select = "{{route('admin.categories-post-management.update-select-box-active',['params'=>':params'])}}"
	        url_select = url_select.replace(":params", arr_size_select);
	        window.location.href = url_select;
	        return;
		}
		if(val_action == 'inactive'){
	        ...
	        url_select = "{{route('admin.categories-post-management.update-select-box-inactive',['params'=>':params'])}}"
	        url_select = url_select.replace(":params", arr_size_select);
	        window.location.href = url_select; 
	        return;
		}
